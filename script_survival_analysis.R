...
# To check whether these required column are present in this TCGA-brca data-----
any(colnames(clinical_brca) %in% c("vital_status", 
                                   "days_to_last_follow_up", "days_to_death"))

# To check whether which number of these these required column in this TCGA-brca data-----
which(colnames(clinical_brca) %in% c("vital_status", "days_to_last_follow_up", 
                                     "days_to_death"))
